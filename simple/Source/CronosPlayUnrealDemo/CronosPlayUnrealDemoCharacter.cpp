...
ACronosPlayUnrealDemoCharacter::ACronosPlayUnrealDemoCharacter() {
    ...
    // asset named MyCharacter (to avoid direct content references in C++)
}

//////////////////////////////////////////////////////////////////////////
// Input

void ACronosPlayUnrealDemoCharacter::SetupPlayerInputComponent(
    ...
    PlayerInputComponent->BindAxis(
        "MoveForward", this, &ACronosPlayUnrealDemoCharacter::MoveForward);
    PlayerInputComponent->BindAxis("MoveRight", this,
                                   &ACronosPlayUnrealDemoCharacter::MoveRight);
    ...
    PlayerInputComponent->BindAxis("TurnRate", this,
                                   &ACronosPlayUnrealDemoCharacter::TurnAtRate);
    PlayerInputComponent->BindAxis("LookUp", this,
                                   &APawn::AddControllerPitchInput);
    PlayerInputComponent->BindAxis(
        "LookUpRate", this, &ACronosPlayUnrealDemoCharacter::LookUpAtRate);

    // handle touch devices
    PlayerInputComponent->BindTouch(
        IE_Pressed, this, &ACronosPlayUnrealDemoCharacter::TouchStarted);
    PlayerInputComponent->BindTouch(
        IE_Released, this, &ACronosPlayUnrealDemoCharacter::TouchStopped);

    // VR headset functionality
    PlayerInputComponent->BindAction(
        "ResetVR", IE_Pressed, this,
        &ACronosPlayUnrealDemoCharacter::OnResetVR);
}

void ACronosPlayUnrealDemoCharacter::OnResetVR() {
    // If CronosPlayUnrealDemo is added to a project via 'Add Feature' in the
    // Unreal Editor the dependency on HeadMountedDisplay in
    // CronosPlayUnrealDemo.Build.cs is not automatically propagated and a
    // linker error will result. You will need to either:
    //		Add "HeadMountedDisplay" to [YourProject].Build.cs
    // PublicDependencyModuleNames in order to build successfully (appropriate
    // if supporting VR). or:
...
void ACronosPlayUnrealDemoCharacter::TouchStarted(ETouchIndex::Type FingerIndex,
                                                  FVector Location) {
    Jump();
}

void ACronosPlayUnrealDemoCharacter::TouchStopped(ETouchIndex::Type FingerIndex,
                                                  FVector Location) {
    StopJumping();
}
