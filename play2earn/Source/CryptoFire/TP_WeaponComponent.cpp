...
void UTP_WeaponComponent::Fire() {
    ...
    if (ProjectileClass != nullptr) {
        ...
        if (World != nullptr) {
            ...
            World->SpawnActor<ACryptoFireProjectile>(
...
void UTP_WeaponComponent::AttachWeapon(ACryptoFireCharacter *TargetCharacter) {
    ...
    if (Character != nullptr) {
        ...
        // Register so that Fire is called every time the character tries to use
        // the item being held
