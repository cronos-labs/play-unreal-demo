...
ACryptoFireProjectile::ACryptoFireProjectile() {
  ...
  CollisionComp->OnComponentHit.AddDynamic(
      this,
      &ACryptoFireProjectile::OnHit); // set up a notification for when this
...
void ACryptoFireProjectile::OnHit(UPrimitiveComponent *HitComp,
                                  AActor *OtherActor,
